...
export const TESTIMONIALS: Testimonial[] = [
  {
    name: "Alex Johnson",
    role: "Product Manager at Rysun Labs",
    content: "Govind's ability to architect scalable solutions is unmatched. He consistently delivers high-quality code that performs under pressure."
  },
  {
    name: "Sarah Chen",
    role: "Tech Lead at Phycom",
    content: "An expert in his field who truly understands the nuances of mobile performance and hardware integration."
  }
];
