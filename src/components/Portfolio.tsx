    ...
    <section id="projects" className="py-24 relative overflow-hidden bg-slate-950 text-slate-100">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-6">
          {PROJECTS.map((project, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-8">
                ...
                <div className="flex gap-2">
                  ...
                  <motion.a
                    ...
                    className="h-10 w-10 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-slate-300 hover:text-white transition-all"
                  >
                  ...
                  <motion.a
                    ...
                    className="h-10 w-10 flex items-center justify-center rounded-full bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold transition-all shadow-lg shadow-sky-500/20"
                  >
              ...
              <div className="relative h-48 w-full mt-auto bg-slate-950 rounded-xl overflow-hidden border border-white/10">
                <img 
                  src={project.image} 
                  alt={project.title}
                  loading="lazy"
                ...
                <div className="absolute top-4 right-4 text-[10px] font-mono text-sky-400 uppercase tracking-widest font-bold">
        ...
        <div className="mt-20 flex justify-center">
           ...
           >
              <span className="text-xs font-mono text-slate-300 group-hover:text-sky-400 font-bold transition-colors uppercase tracking-widest">INITIATE_FULL_CATALOG</span>
